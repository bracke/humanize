...
package body Humanize.Parsing.Implementation.Colors is
   package Impl renames Humanize.Parsing.Implementation.Color_Text_Helpers;
...
end Humanize.Parsing.Implementation.Colors;
