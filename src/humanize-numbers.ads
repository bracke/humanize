...
package Humanize.Numbers is
   ...
   type Distribution_Shape_Kind is
     (No_Distribution_Shape,
      Sample_Too_Small_Shape,
      Flat_Shape,
      Clustered_Shape,
      Wide_Spread_Shape,
      Right_Skewed_Shape,
   ...
   type Distribution_Shape_Metadata is record
      Kind              : Distribution_Shape_Kind := No_Distribution_Shape;
      Count             : Natural := 0;
