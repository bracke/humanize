...
package body Humanize.Parsing.Implementation.Units is
   package Impl renames Humanize.Parsing.Implementation.Support;
   package Unit_Impl renames Humanize.Parsing.Implementation.Unit_Text_Helpers;
   ...
   function Parse_Unit
     (Text : String)
      return Unit_Parse_Result renames Unit_Impl.Parse_Unit;
   ...
   function Scan_Unit
     (Text : String)
      return Unit_Parse_Result renames Unit_Impl.Scan_Unit;
end Humanize.Parsing.Implementation.Units;
