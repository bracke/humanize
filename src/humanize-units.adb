...
package body Humanize.Units is
            ...
            if Name'Length > 0 then
               return
                 (Status => Humanize.Status.Ok,
                  Text   =>
                    To_Unbounded_String (No_Space (Natural'Image (Value)) & " " & Name),
   ...
   begin
      if Style = Abbreviated then
         return Abbreviated_Result
           (No_Space (Natural'Image (Value)) & " " & Abbreviation (Unit));
      end if;
      declare
   ...
   begin
      return Abbreviated_Result
        (No_Space (Natural'Image (Width)) & " x "
         & No_Space (Natural'Image (Height)) & " px");
   ...
   begin
      ...
      return Abbreviated_Result
        (No_Space (Natural'Image (Width / Divisor)) & ":"
         & No_Space (Natural'Image (Height / Divisor)));
